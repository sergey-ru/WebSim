    ...
    Netchart_Data = (function() {
        ...
        function Netchart_Data(chart) {
            ...
            this.runRequests = function() {
                return Netchart_Data.prototype.runRequests.apply(_this, arguments);
            };
        ...
        Netchart_Data.prototype.getNodeLinks = function(id) {
            if (this.nodes.hasOwnProperty(id) && this.nodes[id].expanded) {
        ...
        Netchart_Data.prototype.isExpanded = function(id) {
            return this.nodes.hasOwnProperty(id) && this.nodes[id].expanded;
        };
        ...
        Netchart_Data.prototype.isFilteredNode = function(id) {
            ...
            return !nodeFilter(nodeData, this.isExpanded(id) ? this.nodeToLinks[id] : null);
        };
        ...
        Netchart_Data.prototype.getNodes = function() {
            ...
            for (id in _ref) {
                nodeData = _ref[id];
                if (nodeFilter(nodeData, this.isExpanded(id) ? this.nodeToLinks[id] : null)) {
                    result[id] = nodeData;
                }
            }
            return result;
        ...
        Netchart_Data.prototype.applyLinkFilter = function(nodeId) {
            ...
            if (nodeFilter && !nodeFilter(nodeData, nodeData.expanded ? links : null)) {
                return [];
            }
            if (nodeFilter || linkFilter) {
                ...
                for (_i = 0, _len = links.length; _i < _len; _i++) {
                    ...
                    if (nodeFilter && !nodeFilter(otherNodeData, otherNodeData.expanded ? this.nodeToLinks[otherNodeId] : null)) {
                        continue;
                    }
                    filtered.push(link);
                }
        ...
        Netchart_Data.prototype.runRequests = function() {
            var failFunc, id, nodes, okFunc, r, remainingRequests, request, time, timeout, _, _i, _j, _len, _len1, _ref, _ref1, _ref2,
                    _this = this;
            ...
            while (Base_Helpers.hasProperties(this.pendingNodes) && this.requests.length < this.settings.data.numberOfParralelRequests) {
                nodes = [];
                _ref2 = this.pendingNodes;
                for (id in _ref2) {
                    _ = _ref2[id];
                    nodes.push(id);
                    delete this.pendingNodes[id];
                    this.requestedNodes[id] = true;
                    if (nodes.length > this.settings.data.requestMaxUnits) {
                        break;
                    }
                }
                this.chart.log("Requesting data on " + nodes);
                request = {
                    time: time,
                    nodes: nodes
                };
                ...
                this.dataFunc(nodes, okFunc, failFunc);
        ...
        Netchart_Data.prototype.dataArrived = function(request, rawData) {
            var allOk, data, expanded, ids, key, n, obj, required, updatedNodes, value, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _m, _n, _ref, _ref1, _ref2, _ref3, _ref4, _ref5;
            allOk = false;
            if (rawData) {
        ...
        Netchart_Data.prototype.dumpData = function(shuffleIds) {
            ...
            result = JSON.stringify({
                nodes: n,
                links: l
            }, ["nodes", "links", "id", "from", "to", "type", "state", "expanded", "Employees", "position_title", "start", "end", "shares_perc", "terminated", "status", "finanses", "Turnover_prev", "Employees_prev"], "  ");
...
// Generated by CoffeeScript 1.6.1
    ...
    Netchart_Graph = (function() {
        ...
        Netchart_Graph.prototype.onSceneChange = function(event) {
            ...
            dataNodesSorted = [];
            _ref1 = event.changes.dataExpandedNodeIds;
            for (id in _ref1) {
                _ = _ref1[id];
                dataNodesSorted.push(id);
            }
...
// Generated by CoffeeScript 1.6.1
    ...
    Netchart_Layout_TimedSpringEmbedder = (function() {
        ...
        Netchart_Layout_TimedSpringEmbedder.prototype.updateGraph = function(nodes, links, topologyChanges) {
            var desiredLen, desiredStrength, e, from, fsum, id, idx, lenSum, length, lengthProp, link, n, nn, node, oldIdToIndex, oldIdx, oldNode, oldNodes, oldOldForceX, oldOldForceY, oldOldForceZ, relevantEdgeCount, strength, sum, to, ton, vis, w, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _len6, _m, _n, _o, _ref, _ref1, _ref2, _ref3;
            ...
            return this.unitTemperature = lenSum / relevantEdgeCount / 30;
        };
    ...
    Base_MouseEvents = (function() {
        ...
        function Base_MouseEvents(container, settings) {
            ...
            this.handleTouchMove = function(event) {
                return Base_MouseEvents.prototype.handleTouchMove.apply(_this, arguments);
            };
            this.handleTouchEnd = function(event) {
                return Base_MouseEvents.prototype.handleTouchEnd.apply(_this, arguments);
            };
            this.handleTouchStart = function(event) {
                return Base_MouseEvents.prototype.handleTouchStart.apply(_this, arguments);
            };
            this.handleMouseMove = function(event) {
                return Base_MouseEvents.prototype.handleMouseMove.apply(_this, arguments);
            };
            this.handleMouseUp = function(event) {
                return Base_MouseEvents.prototype.handleMouseUp.apply(_this, arguments);
            };
            this.handleMouseWheel = function(event) {
                return Base_MouseEvents.prototype.handleMouseWheel.apply(_this, arguments);
            };
            this.handleCMenu = function(event) {
                return Base_MouseEvents.prototype.handleCMenu.apply(_this, arguments);
            };
            this.handleMouseDown = function(event) {
                return Base_MouseEvents.prototype.handleMouseDown.apply(_this, arguments);
            };
            this.updateContainerPosition = function() {
                return Base_MouseEvents.prototype.updateContainerPosition.apply(_this, arguments);
            };
            this.listeners = {};
            this.downPointers = {};
            this.inPointers = {};
...
// Generated by CoffeeScript 1.6.1
    ...
    Netchart_Node = (function() {
        ...
        Netchart_Node.prototype.toId = false;             // keren
    ...
    Netchart_Link = (function() {
        ...
        Netchart_Link.prototype.runMovingMessage = false; // keren
        
        Netchart_Link.prototype.runMovingMessageStepX = false;  // keren
        
        Netchart_Link.prototype.runMovingMessageStepY = false;  // keren
    ...
    Netchart_Layout = (function() {
        ...
        Netchart_Layout.prototype.animateChanges = function(time, dt) {
            ...
            for (_i = 0, _len = _ref.length; _i < _len; _i++) {
                ...
                } else if (node.targetRadius !== node.currentRadius) {
                    animating = true;
...
// Generated by CoffeeScript 1.6.1
    ...
    Netchart_Styles = (function() {
        ...
        Netchart_Styles.prototype.doAnimations = function(event) {
            var id2, id3, link, link1, node, node1, _i, _j, _len, _len1, _ref, _ref1, _ref2, _ref3;
        ...
        Netchart_Styles.prototype.updateNode = function(node) {
            var active, l, originalRadius, _i, _len, _ref;
            active = node === this.scene.activeNode;
        ...
        Netchart_Styles.prototype.updateLink = function(link) {
            var active, originalRadius;
            ...
            link.radius = 1;
            active = link === this.scene.activeLink || link.from === this.scene.activeNode || link.to === this.scene.activeNode;
            if (link.data.style) {
            ...
            if (active) {
                ...
                if (link.from === this.scene.activeNode) {
        ...
        Netchart_Styles.prototype.computeRadiuses = function(objects, mode, extents) {
            ...
            if (mode === "linear" || mode === "logarithmic") {
                ...
                if (min >= max) {
                    ...
                    for (_j = 0, _len1 = objects.length; _j < _len1; _j++) {
                        obj = objects[_j];
                        if (!obj.removed) {
                            _results.push(obj.targetRadius = minE);
                        } else {
                            _results.push(void 0);
                        }
                    }
                    ...
                    for (_k = 0, _len2 = objects.length; _k < _len2; _k++) {
                        obj = objects[_k];
                        if (!obj.removed) {
                            _results1.push(obj.targetRadius = obj.radius * mul + add);
                        } else {
                    ...
                    for (_l = 0, _len3 = objects.length; _l < _len3; _l++) {
                        obj = objects[_l];
                        if (!obj.removed) {
                            _results2.push(obj.targetRadius = Math.log(Math.max(0.0001, obj.radius)) * mul + add);
                        } else {
                ...
                for (_m = 0, _len4 = objects.length; _m < _len4; _m++) {
                    obj = objects[_m];
                    if (!obj.removed) {
                        _results3.push(obj.targetRadius = Math.min(Math.max(minE, obj.radius), maxE));
                    } else {
    ...
    Netchart_ZoomControl = (function() {
        ...
        function Netchart_ZoomControl(chart) {
            var cont, mouse, nav, zoom,
                    _this = this;
            this.chart = chart;
            this.freeze = function(event) {
                return Netchart_ZoomControl.prototype.freeze.apply(_this, arguments);
            };
            this.resetLayout = function(event) {
                return Netchart_ZoomControl.prototype.resetLayout.apply(_this, arguments);
            };
            this.zoomToFit = function(event) {
                return Netchart_ZoomControl.prototype.zoomToFit.apply(_this, arguments);
            };
            this.zoomMove = function(event) {
                return Netchart_ZoomControl.prototype.zoomMove.apply(_this, arguments);
            };
            this.zoomDown = function(event) {
                return Netchart_ZoomControl.prototype.zoomDown.apply(_this, arguments);
            };
            this.scene = chart.scene;
            this.events = chart.events;
            this.scrolling = this.chart.scrolling;
            cont = Base_Helpers.createDom("div", "NC-zoom", null, this.chart.layers.container);
            ...
            this.fit = Base_Helpers.createDom("a", "NC-zoom-fit", "Fit to screen", nav);
            this.fit.title = "Fit to screen";
            this.rearrange = Base_Helpers.createDom("a", "NC-zoom-rearrange", "Rearrange elements", nav);
            this.rearrange.title = "Rearrange elements";
            this.lock = Base_Helpers.createDom("a", "NC-zoom-lock-all", "Locak all", nav);
        ...
        Netchart_ZoomControl.prototype.doAnimations = function(event) {
            ...
            if (this.scene.settings.interaction.zooming.autoZoom) {
                Base_Helpers.setClass(this.fit, "NC-zoom-fit-active");
            } else {
                Base_Helpers.setClass(this.fit, "NC-zoom-fit");
            }
            if (this.scene.settings.layout.layoutMode === "dynamic") {
                return Base_Helpers.setClass(this.lock, "NC-zoom-lock-all");
            } else {
                return Base_Helpers.setClass(this.lock, "NC-zoom-lock-all-active");
            }
        };
    ...
    Base_ChartEvents = (function() {
        ...
        function Base_ChartEvents(container, canvas, chart) {
            ...
            this._paintScene = function() {
                return Base_ChartEvents.prototype._paintScene.apply(_this, arguments);
            };
            this.kd = function(event) {
                return Base_ChartEvents.prototype.kd.apply(_this, arguments);
            };
            this.mw = function(event) {
                return Base_ChartEvents.prototype.mw.apply(_this, arguments);
            };
            this.mdbl = function(event) {
                return Base_ChartEvents.prototype.mdbl.apply(_this, arguments);
            };
            this.rcl = function(event) {
                return Base_ChartEvents.prototype.rcl.apply(_this, arguments);
            };
            this.mcl = function(event) {
                return Base_ChartEvents.prototype.mcl.apply(_this, arguments);
            };
            this.mlve = function(event) {
                return Base_ChartEvents.prototype.mlve.apply(_this, arguments);
            };
            this.mmve = function(event) {
                return Base_ChartEvents.prototype.mmve.apply(_this, arguments);
            };
            this.mdrg = function(event) {
                return Base_ChartEvents.prototype.mdrg.apply(_this, arguments);
            };
            this.mup = function(event) {
                return Base_ChartEvents.prototype.mup.apply(_this, arguments);
            };
            this.mdwn = function(event) {
                return Base_ChartEvents.prototype.mdwn.apply(_this, arguments);
            };
            this.scene = this.chart.scene;
            this.settings = this.chart.settings;
            this.elements = [];
    ...
    Base_Impl = (function() {
        ...
        function Base_Impl(settings) {
            ...
            this.loadAssets = function() {
                return Base_Impl.prototype.loadAssets.apply(_this, arguments);
            };
            this.defaultError = function(event) {
                return Base_Impl.prototype.defaultError.apply(_this, arguments);
            };
            this._windowResize = function() {
                return Base_Impl.prototype._windowResize.apply(_this, arguments);
            };
...
// Generated by CoffeeScript 1.6.1
    ...
    Netchart_Renderer = (function() {
        ...
        Netchart_Renderer.prototype.paintScene = function(event) {
            ...
            return event.animating |= this.doPainting(event.context, event.time);
        };
        ...
        Netchart_Renderer.prototype.doPainting = function(g, time) {
            var PI2, a, active, animating, count, dashLen, ddx, ddy, decorationSize, dx, dy, grad, hiddenLinksStyle, hlinks, i, iconAngle, iconDistance, iconRadius, im, invlen, l0, l1, len, lh, link, linkLabelMinZoom, linkSpacing, lx, ly, ml, multiId, multiLinks, node, nodeDetailMinZoom, nodeLabelMinSize, offset, paintDetails, paintIcons, pieInner, pieOuter, pieSizeConst, pieSizeProp, pieSpacing, r, r0, r1, rr, s, str, style, txa, txm, tya, tym, width, x, x0, x0a, x0b, x0s, x0w, x1, x1s, x1w, y, y0, y0a, y0b, y0s, y0w, y1, y1s, y1w, zoom, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _n, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6;
            PI2 = Math.PI * 2;
            animating = false;
            ...
            for (_j = 0, _len1 = _ref2.length; _j < _len1; _j++) {
                ...
                if ((zoom > linkLabelMinZoom || active) && (link.label != null) && !link.removed) {
                    ...
                    if (str.length > 0) {
                        lx = x0 + dx * 0.5;
                        ly = y0 + dy * 0.5;
                        this.paintLabel(g, lx, ly, link.label, link.labelStyle, link.labelBackground);
                    }
                }
            }
            ...
            for (_l = 0, _len2 = _ref4.length; _l < _len2; _l++) {
                ...
                r = r * zoom;
                if (node.highlight) {
                    this.paintHilight(g, x, y, rr, zoom, node.highlight);
                }
                ...
                if (zoom >= nodeDetailMinZoom || node.active) {
                    ...
                    if (im != null) {
                        if (node.imageSlicing) {
                            s = node.imageSlicing;
                            g.drawImage(im, s[0], s[1], s[2], s[3], x - r, y - r, r * 2, r * 2);
                        } else {
                            g.drawImage(im, 0, 0, im.width, im.height, x - r, y - r, r * 2, r * 2);
                        }
                    }
                    if (!node.removed) {
                        if (paintIcons && node.icons && node.icons.length) {
                            this.paintNodeIcons(g, x, y, r + iconDistance, iconAngle, iconRadius, node.icons);
                        }
                    }
                }
            }
            ...
            for (_n = 0, _len4 = _ref6.length; _n < _len4; _n++) {
                ...
                this.paintLabel(g, x, y, node.label, node.labelStyle, node.labelBackground);
            }
            if ((this.scene.activeNode != null) && this.scene.activeNode.label) {
                node = this.scene.activeNode;
                x = node.x * txm + txa;
                y = node.y * tym + tya;
                if (node.labelLocation === "inside") {
                    y += node.currentRadius * zoom / 2;
        ...
        Netchart_Renderer.prototype.paintSelection = function(g) {
            var PI2, cons, ddx, ddy, dx, dy, invLen, n1, n2, obj, prop, r, selStyle, txa, txm, tya, tym, x, x0, x0s, x0w, x1, x1s, x1w, y, y0, y0s, y0w, y1, y1s, y1w, zoom, _i, _len, _ref, _ref1;
            if (!(this.scene.selection.length > 0)) {
                return;
            }
            _ref = this.getGeometry(), txm = _ref[0], txa = _ref[1], tym = _ref[2], tya = _ref[3], zoom = _ref[4], x0s = _ref[5], x1s = _ref[6], y0s = _ref[7], y1s = _ref[8], x0w = _ref[9], y0w = _ref[10], x1w = _ref[11], y1w = _ref[12];
        ...
        Netchart_Renderer.prototype.paintLabel = function(g, x, y, text, labelStyle, balloonStyle) {
            var lh, lw;
        ...
        Netchart_Renderer.prototype.paintHilight = function(g, x, y, r, zoom, style) {
            var PI2;
            PI2 = Math.PI * 2;
...
// Generated by CoffeeScript 1.6.1
    ...
    Netchart_InfoPopup = (function() {
        "use strict";
        Netchart_InfoPopup.prototype.animationPriority = 10;

        Netchart_InfoPopup.prototype.node = null;

        Netchart_InfoPopup.prototype.link = null;

        Netchart_InfoPopup.prototype.contents = null;

        Netchart_InfoPopup.prototype.x = 0;

        Netchart_InfoPopup.prototype.y = 0;
        ...
        function Netchart_InfoPopup(chart) {
            ...
            this.events = chart.events;
            this.buttons = [];
            this.popup = Base_Helpers.createDom("div", "NC-bar-info", null, this.container);
            closeButton = Base_Helpers.createDom("a", "NC-close", "X", this.popup);
            this.popupValue = Base_Helpers.createDom("div", null, null, this.popup);
            this.detailsDiv = Base_Helpers.createDom("div", "NC-bar-details", null, this.popup);
        ...
        Netchart_InfoPopup.prototype.previewWheel = function(event) {
            return this.hideInfoPopup();
        };

        Netchart_InfoPopup.prototype.toggleNodeMenu = function(node) {
            if (this.node === node) {
                return this.hideInfoPopup();
            } else {
        ...
        Netchart_InfoPopup.prototype.toggleLinkMenu = function(x, y, link) {
            if (this.link === link) {
                return this.hideInfoPopup();
            } else {
        ...
        Netchart_InfoPopup.prototype.showNodeMenu = function(node) {
        ...
        Netchart_InfoPopup.prototype.showLinkMenu = function(x, y, link) {
        ...
        Netchart_InfoPopup.prototype.showPopup = function(node, link) {
            this.node = node;
            this.link = link;
            if (this.node) {
                this.node.locks += 1;
        ...
        Netchart_InfoPopup.prototype.hideInfoPopup = function() {
        ...
        Netchart_InfoPopup.prototype.updateInfoPopup = function() {
        ...
        Netchart_InfoPopup.prototype.updateXY = function() {
        ...
        Netchart_InfoPopup.prototype.buildButtons = function() {
            ...
            if (this.node != null) {
                ...
                for (_i = 0, _len = _ref.length; _i < _len; _i++) {
                    button = _ref[_i];
                    if (button === "expand") {
                        div = Base_Helpers.createDom("a", "NC-button-expand", null, this.popupActions);
                        action = this.updateExpandButton;
                    } else if (button === "focus") {
                        div = Base_Helpers.createDom("a", "NC-button-focus", null, this.popupActions);
                        action = this.updateFocusButton;
                    } else if (button === "lock") {
                        div = Base_Helpers.createDom("a", "NC-button-lock", null, this.popupActions);
                        action = this.updateLockButton;
                    } else if (button === "hide") {
                        div = Base_Helpers.createDom("a", "NC-button-hide", null, this.popupActions);
        ...
        Netchart_InfoPopup.prototype.updateButtons = function() {
            var b, _i, _len, _ref;
            _ref = this.buttons;
            for (_i = 0, _len = _ref.length; _i < _len; _i++) {
                b = _ref[_i];
        ...
        Netchart_InfoPopup.prototype.updateExpandButton = function(div) {
            var _this = this;
            if (!this.node.expanded || this.node.dataLinks.length > this.node.links.length) {
                div.className = "NC-button-expand";
                div.title = "Expand";
                div.innerHTML = "Expand";
                return div.onclick = function() {
                    return _this.chart.expandNode(_this.node.id, 1);
                };
            } else {
                div.className = "NC-button-collapse";
                div.title = "Collapse";
                div.innerHTML = "Collapse";
                return div.onclick = function() {
                    return _this.chart.collapseNode(_this.node.id);
                };
            }
        };

        Netchart_InfoPopup.prototype.updateFocusButton = function(div) {
            var _this = this;
            if (this.node.focused) {
                div.className = "NC-button-unfocus";
                div.title = "Unfocus";
                div.innerHTML = "Unfocus";
                return div.onclick = function() {
                    return _this.chart.removeFocusNode(_this.node.id);
                };
            } else {
                div.className = "NC-button-focus";
                div.title = "Focus";
                div.innerHTML = "Focus";
                return div.onclick = function() {
                    return _this.chart.addFocusNode(_this.node.id);
                };
            }
        };

        Netchart_InfoPopup.prototype.updateLockButton = function(div) {
            var _this = this;
            if (this.node.userLock) {
                div.className = "NC-button-lock";
                div.title = "Fixed";
                div.innerHTML = "Fixed";
                return div.onclick = function() {
                    return _this.chart.unlockNode(_this.node.id);
                };
            } else {
                div.className = "NC-button-unlock";
                div.title = "Dynamic";
                div.innerHTML = "Dynamic";
                return div.onclick = function() {
                    return _this.chart.lockNode(_this.node.id);
                };
            }
        };

        Netchart_InfoPopup.prototype.updateHideButton = function(div) {
            var _this = this;
            div.className = "NC-button-hide";
            div.title = "Hide";
            div.innerHTML = "Hide";
            return div.onclick = function() {
                return _this.chart.hideNode(_this.node.id);
            };
        };

        Netchart_InfoPopup.prototype.buildCloseButton = function(a) {
            var _this = this;
            a.title = this.scene.settings.localization.closeButton;
            a.href = "#";
            return a.onclick = function() {
                return _this.hideInfoPopup();
            };
        };

        Netchart_InfoPopup.prototype.buildDetailsPanel = function(div) {
            var a, d;
...
// Generated by CoffeeScript 1.6.1
    ...
    Netchart_Impl = (function(_super) {
        ...
        function Netchart_Impl(settings, api) {
            var _this = this;
            this.defaultDoubleClick = function(event) {
                return Netchart_Impl.prototype.defaultDoubleClick.apply(_this, arguments);
            };
            this.defaultRightClick = function(event) {
                return Netchart_Impl.prototype.defaultRightClick.apply(_this, arguments);
            };
            this.defaultClick = function(event) {
                return Netchart_Impl.prototype.defaultClick.apply(_this, arguments);
            };
            this.onSizeChanged = function(clientWidth, clientHeight) {
                return Netchart_Impl.prototype.onSizeChanged.apply(_this, arguments);
            };
            Netchart_Impl.__super__.constructor.call(this, settings);
        ...
        Netchart_Impl.prototype.EVENT_NAMES = {
        ...
        Netchart_Impl.prototype.onSettingsChanged = function(changes) {
            ...
            if ((changes.data != null) && (changes.data.dataFunction || changes.data.format || (changes.data.units != null))) {
                if (this.scene.data) {
        ...
        Netchart_Impl.prototype.notifySelectionChanged = function(origin) {
        ...
        Netchart_Impl.prototype.defaultRightClick = function(event) {
            if (event.clickNode != null) {
                ...
                this.info.toggleNodeMenu(event.clickNode);
                event.preventDefault();
            }
            if (event.clickLink != null) {
                this.info.toggleLinkMenu(event.x, event.y, event.clickLink);
                return event.preventDefault();
            }
        };
