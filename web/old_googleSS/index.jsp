    ...
    <body>
        <form id="form1">
            ...
            <div class="ui-layout-north">
                <h1><p>Simulator</p></h1>
                <input id="spreadSheetId" type="hidden">
                <input id="spreadSheetScenario" type="hidden">
                <hr/>
            </div>
                ...
                <div id="myTabContent" class="tab-content">
                    ...
                    <div class="tab-pane fade" id="view">
                        <div id="ViewSimulatorDiv">
                            <span id="controlSpan" style="alignment-adjust: central;">
                                <h3><span id="scenarioNumberInfo" class="label label-info">Scenario</span></h3>
                                ...
                                <button type="button" id="Restart" class="btn btn-primary btn-lg doAction"><span class="glyphicon glyphicon-play"></span>Restart</button>
                    ...
                    <div class="tab-pane fade" id="stat">
                        <div id="StatisticsDiv">
                            <div class="center">
                                <center>
                                    <span id="debuging">blaaaa</span>
                                    <span id="loadingSpreadsheet" style="margin-top: 100px;"><img src='Images/ajax-loader.gif' width="20%"/></span>
