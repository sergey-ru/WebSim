...
<html>
    <head>
        ...
        <!--  Layout -->
        <link href="JS/Splitter/themes/aristo/jquery-wijmo.css" rel="stylesheet" type="text/css" />
        <link href="JS/Splitter/themes/wijmo/jquery.wijmo.wijsplitter.css" rel="stylesheet" type="text/css" />
        <script src="JS/Splitter/external/jquery-1.8.2.min.js" type="text/javascript"></script>
        <script src="JS/Splitter/external/jquery-ui-1.9.1.custom.min.js" type="text/javascript"></script>
        <script src="JS/Splitter/wijmo/jquery.wijmo.wijutil.js" type="text/javascript"></script>
        <script src="JS/Splitter/wijmo/jquery.wijmo.wijsplitter.js" type="text/javascript"></script>
                ...
                <div id="splitter2">
                            ...
                            <div id="myTabContent" class="tab-content">
                                <div class="tab-pane fade in active" id="home">
                                    ...
                                    <div id="RunSimDiv">
                                        ...
                                        <table border="0" style="width: 100%;">
                                            ...
                                            <tr>
                                                <td style="width: 60%; margin-top: 8px;">
                                                ...
                                                <td style="width: 10%"><button type="button" id="UploadFileButton" onclick="uploadXmlTreeFile();" class ="btn btn-primary" accept=".xml" style="width: 100%;">Upload</button></td>
                                                <td style="width: 5%;"></td>
                                        ...
                                        <table border="0" style="width: 100%;">
                                            <tr>
                                                ...
                                                <td style="width: 10%"><button type="button" id="UploadFileButton2" onclick="uploadNetFile();" class ="btn btn-primary" accept=".xml" style="width: 100%;">Upload</button></td>
                                                <td style="width: 2%;"></td>
                                ...
                                <div class="tab-pane fade" id="view">
                                    <div id="ViewSimulatorDiv">
                                        ...
                                        <!-- Graph -->
                                        <iframe id="iframeID" src="Graph/SimViewGraph.html" height="850" width="100%" frameborder="0"></iframe>
                                        <div id="output6"></div>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade" id="stat">
                                    <div id="StatisticsDiv">
                                        <div class="center">
                                            <center>
                                                <iframe id="iframeStat" src="Statistics/statistics.html" style="margin: 5px 5px 5px 5px; width: 92%; height: 92%" frameborder="0"></iframe>
                                            </center>
                                        </div>
                                    </div>  
                                </div>
                    ...
                    <div>
                        <div id="splitter3">
                            ...
                            <div>
                                <iframe id="iframeStat" src="Chart/Chart.html" style="margin: 5px 5px 5px 5px; width: 92%; height: 92%" frameborder="0"></iframe>
                                <div id="output6"></div>
                            </div>
                        </div>
                    </div>
